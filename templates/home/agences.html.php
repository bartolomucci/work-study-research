...
<table class="table table-bordered">
    ...
    <?php foreach ($data as $key) : ?>
        <tbody>
            <tr class="text-center">
                <td class="font-weight-bold"><?= $key['name'] ?></td>
                <td><a class="btn btn-secondary" href="<?= $key['url'] ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
...
{
    echo '<td class="text-primary">' . $key['email'] .  '</td>';
}
else
{
    echo '<td class="text-muted">' . $key['email'] .  '</td>';
}
?>
